...
compile_error!(
    "the display_log_reader example requires the `mobility` feature.\n\
     Build it with: cargo run --example display_log_reader --features mobility\n\
