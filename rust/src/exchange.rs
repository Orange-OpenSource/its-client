...
use crate::exchange::etsi::relevance_distance::RelevanceDistance;
use crate::exchange::etsi::relevance_traffic_direction::RelevanceTrafficDirection;
...
mod tests {
                                ...
                                "vehicle_sensor_property_list": [
                                    {
                                        ...
                                        "vertical_opening_angle_end": 1200
                                    }
                                ],
                                "ref_point_id": 0                           
                            }
    ...
    fn it_can_deserialize_then_serialize_a_standard_cam() {
        ...
        if let Message::CAM(message) = cam.message {
            let basic_vehicle_container_high_frequency = message
                .high_frequency_container
                .basic_vehicle_container_high_frequency
                .unwrap();
            assert_eq!(basic_vehicle_container_high_frequency.speed.value, 365);
        } else {
    ...
    fn it_can_deserialize_then_serialize_a_full_cam() {
        ...
        if let Message::CAM(message) = cam.message {
            let basic_vehicle_container_high_frequency = message
                ...
                .basic_vehicle_container_high_frequency
                .unwrap();
            assert_eq!(basic_vehicle_container_high_frequency.speed.value, 253);
            assert_eq!(
        ...
        if let Message::DENM(message) = &denm.message {
            ...
            match &message.situation_container {
                Some(s) => {
                    ...
                    assert_eq!(s.information_quality, 3);
