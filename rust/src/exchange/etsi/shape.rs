...
///
/// This message is used to describe an shape.
/// It implements the schema defined in the CPM version 2.1.0.
///
/// # Fields
///
/// - `rectangular`: The rectangular shape.
/// - `circular`: The circular shape.
/// - `polygonal`: The polygonal shape.
/// - `elliptical`: The elliptical shape.
/// - `radial`: The radial shape.
/// - `radial_shapes`: The radial shapes.
