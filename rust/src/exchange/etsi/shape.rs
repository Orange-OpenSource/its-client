...
pub struct Shape {
    /// The rectangular shape (Optional).
    pub rectangular: Option<Rectangular>,
    /// The circular shape (Optional).
    pub circular: Option<Circular>,
    /// The polygonal shape (Optional).
    pub polygonal: Option<Polygonal>,
    /// The elliptical shape (Optional).
    pub elliptical: Option<Elliptical>,
    /// The radial shape (Optional).
    pub radial: Option<Radial>,
    /// The radial shapes (Optional).
