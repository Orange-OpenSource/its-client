...
from .gnss import (
    GNSSReport,
    compute_position_confidence_ellipse,
    _altitude_error_to_confidence,
)
                    ...
                    "basic_container": {
                        ...
                        "reference_position": {
                            ...
                            "position_confidence_ellipse": (
                                compute_position_confidence_ellipse(gnss_report)
                            ),
                            "altitude": {
                                ...
                                "confidence": _altitude_error_to_confidence(
                                    gnss_report.altitude_error,
                                ),
                            },
                        },
                    },
