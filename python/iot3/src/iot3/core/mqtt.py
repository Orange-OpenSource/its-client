...
class MqttClient:
    def __init__(
        ...
        *,
        ...
        :param username: The username to authenticate agaisnt the MQTT broker.
        :param password: The password to authenticate agaisnt the MQTT broker.
    ...
    def is_ready(self):
        ...
        The client is ready when it is connected to the MQTT borker.
        """
