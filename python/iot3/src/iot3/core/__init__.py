...
* Functions:
  ...
  * ready(): returns whether the MQTT client is ready
...
def start(
    *,
    ...
    :param message_callback: The function to call when a message is
                             ...
                             the topic the emsage was received on, and
...
def is_ready() -> bool:
    """Checkxs whether the IoT3 Core SDK is ready.
...
def wait_for_ready():
    ...
    Beware that this may take an undeterminate amount of time; in
