...
_Note: some of the provided implementations are compatible with different schema versions for a given message,
they are using the following versions:

|      Schema       |                                        Rust                                         |                          Python                           |                                                                Java                                                                 |                    Swift                    |
|:-----------------:|:-----------------------------------------------------------------------------------:|:---------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------:|
|   **Bootstrap**   |                                                                                     |                                                           |                                                                                                                                     |                                             |
|      **CAM**      | [2.4.0](schema/cam/cam_schema_2-4-0.json) [1.1.3](schema/cam/cam_schema_1-1-3.json) |         [1.1.3](schema/cam/cam_schema_1-1-3.json)         |                         [2.3.0](schema/cam/cam_schema_2-3-0.json) [1.1.3](schema/cam/cam_schema_1-1-3.json)                         |  [1.1.3](schema/cam/cam_schema_1-1-3.json)  |
...
|      **MCM**      |                                                                                     |                                                           |                                              [2.0.0](schema/mcm/mcm_schema_2-0-0.json)                                              |                                             |
| **Neighbourhood** |                                                                                     |                                                           |                                                                                                                                     |                                             |
|     **POIM**      |                                                                                     |                                                           |                                                                                                                                     |                                             |
|    **Region**     |                                                                                     |                                                           |                                                                                                                                     |                                             |
