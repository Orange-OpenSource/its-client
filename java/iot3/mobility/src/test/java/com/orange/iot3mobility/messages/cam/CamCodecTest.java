...
class CamCodecTest {
    ...
    @Test
    void writeRead240RoundTrip() throws Exception {
        CamEnvelope240 envelope = validEnvelope240();
        CamCodec codec = new CamCodec(new JsonFactory());
    ...
    @Test
    void writeRead240WithLinkedStationIdRoundTrip() throws Exception {
        CamEnvelope240 envelope = validEnvelope240WithLinkedStationId();
        CamCodec codec = new CamCodec(new JsonFactory());
    ...
    private static CamEnvelope240 validEnvelope240() {
