 ...
 */
package com.orange.iot3mobility.messages.cam.v240.codec;

import com.fasterxml.jackson.core.JsonFactory;
import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.core.JsonToken;
import com.orange.iot3mobility.messages.cam.v240.model.*;
import com.orange.iot3mobility.messages.cam.v240.model.basiccontainer.*;
...
import com.orange.iot3mobility.messages.cam.v240.model.specialvehiclecontainer.*;
import com.orange.iot3mobility.messages.cam.v240.validation.CamValidationException;
import com.orange.iot3mobility.messages.cam.v240.validation.CamValidator240;
...
/**
 * Streaming JSON reader for CAM 2.4.0 payloads (structured JSON or ASN.1).
 */
public final class CamReader240 {

    private final JsonFactory jsonFactory;

    public CamReader240(JsonFactory jsonFactory) {
        this.jsonFactory = Objects.requireNonNull(jsonFactory, "jsonFactory");
    }

    public CamEnvelope240 read(InputStream in) throws IOException {
        try (JsonParser parser = jsonFactory.createParser(in)) {
            ...
            Long timestamp = null;
            String version = null;
            Long linkedStationId = null;
            CamMessage240 payload = null;
            ...
            while (parser.nextToken() != JsonToken.END_OBJECT) {
                ...
                switch (field) {
                    ...
                    case "linked_station_id" -> linkedStationId = parser.getLongValue();
                    case "message" -> payload = readPayload(parser);
                    default -> parser.skipChildren();
                }
            }

            CamEnvelope240 envelope = new CamEnvelope240(
                    messageType,
                    messageFormat,
                    sourceUuid,
    ...
    private CamMessage240 readPayload(JsonParser parser) throws IOException {
