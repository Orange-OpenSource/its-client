 ...
 * @param xDistance Distance to detected object in x-direction. Unit: 0.01 meter. Value: zeroPointZeroOneMeter(1),
 *                  oneMeter(100).
 * @param yDistance Distance to detected object in y-direction. Unit: 0.01 meter. Value: zeroPointZeroOneMeter(1),
 *                  oneMeter(100).
 * @param xSpeed Speed in x-direction. Unit: 0.01 m/s. Value: negativeSpeedMaximum(-16383), standstill(0),
 *               oneCentimeterPerSec(1), speedMaximum(16382), unavailable(16383).
 * @param ySpeed Speed in y-direction. Unit: 0.01 m/s. Value: negativeSpeedMaximum(-16383), standstill(0),
 *               oneCentimeterPerSec(1), speedMaximum(16382), unavailable(16383).
 ...
 * @param zDistance Optional. Distance to detected object in z-direction. Unit: 0.01 meter.
 *                  Value: zeroPointZeroOneMeter(1), oneMeter(100).
 * @param zSpeed Optional. Speed in z-direction. Unit: 0.01 m/s. Value: negativeSpeedMaximum(-16383), standstill(0),
 *               oneCentimeterPerSec(1), speedMaximum(16382), unavailable(16383).
 * @param xAcceleration Optional. Acceleration in x-direction. Unit: 0.1 m/s2. Value: pointOneMeterPerSecSquared(1),
 *                      minusPointOneMeterPerSecSquared(-1), unavailable(161).
 * @param yAcceleration Optional. Acceleration in y-direction. Unit: 0.1 m/s2. Value: pointOneMeterPerSecSquared(1),
 *                      minusPointOneMeterPerSecSquared(-1), unavailable(161).
 * @param zAcceleration Optional. Acceleration in z-direction. Unit: 0.1 m/s2. Value: pointOneMeterPerSecSquared(1),
 *                      minusPointOneMeterPerSecSquared(-1), unavailable(161).
 * @param rollAngle Optional. Roll angle of object. Unit: 0.1 degree. Value: zeroPointOneDegree(1), oneDegree(10),
 *                  unavailable(3601).
 * @param pitchAngle Optional. Pitch angle of object. Unit: 0.1 degree. Value: zeroPointOneDegree(1), oneDegree(10),
 *                   unavailable(3601).
 * @param yawAngle Optional. Yaw angle of object. Unit: 0.1 degree. Value: zeroPointOneDegree(1), oneDegree(10),
 *                 unavailable(3601).
 * @param rollRate Optional. Roll rate of object. Unit: 0.01 degree/s. Value: noSpeed(0),
 *                 oneDegreePerSecondAntiClockwise(100), oneDegreePerSecondClockwise(-100).
 * @param pitchRate Optional. Pitch rate of object. Unit: 0.01 degree/s. Value: noSpeed(0),
 *                  oneDegreePerSecondAntiClockwise(100), oneDegreePerSecondClockwise(-100).
 * @param yawRate Optional. Yaw rate of object. Unit: 0.01 degree/s. Value: noSpeed(0),
 *                oneDegreePerSecondAntiClockwise(100), oneDegreePerSecondClockwise(-100).
 * @param rollAcceleration Optional. Roll acceleration of object. Unit: 0.01 degree/s^2. Value: noAcceleration(0),
 *                         oneDegreePerSecondSquaredAntiClockwise(100), oneDegreePerSecondSquaredClockwise(-100).
 * @param pitchAcceleration Optional. Pitch acceleration of object. Unit: 0.01 degree/s^2. Value: noAcceleration(0),
 *                          oneDegreePerSecondSquaredAntiClockwise(100), oneDegreePerSecondSquaredClockwise(-100).
 * @param yawAcceleration Optional. Yaw acceleration of object. Unit: 0.01 degree/s^2. Value: noAcceleration(0),
 *                        oneDegreePerSecondSquaredAntiClockwise(100), oneDegreePerSecondSquaredClockwise(-100).
 * @param lowerTriangularCorrelationMatrixColumns Optional. Lower triangular correlation matrix columns.
 *                                                Value: [-100..100] scaled by 100.
 * @param planarObjectDimension1 Optional. First planar dimension. Unit: 0.1 meter. Value: zeroPointOneMeter(1),
 *                               oneMeter(10).
 * @param planarObjectDimension2 Optional. Second planar dimension. Unit: 0.1 meter. Value: zeroPointOneMeter(1),
 *                               oneMeter(10).
 * @param verticalObjectDimension Optional. Vertical dimension. Unit: 0.1 meter. Value: zeroPointOneMeter(1),
 *                                oneMeter(10).
 * @param objectRefPoint Optional. Object reference point. Value: mid(0), bottomLeft(1), midLeft(2), topLeft(3),
 *                       bottomMid(4), topMid(5), bottomRight(6), midRight(7), topRight(8).
 * @param sensorIdList Optional. List of sensor IDs providing measurement data. Value: [0..255].
 * @param dynamicStatus Optional. Dynamic status of detected object. Value: dynamic(0), hasBeenDynamic(1), static(2).
 * @param classification Optional. {@link ObjectClassification}
 * @param matchedPosition Optional. Map-matched position {@link MapPosition}
 */
