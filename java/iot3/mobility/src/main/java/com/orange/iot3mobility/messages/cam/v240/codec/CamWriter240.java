...
/**
 * Streaming JSON writer for CAM 2.4.0 payloads (structured JSON or ASN.1).
 */
public final class CamWriter240 {

    private final JsonFactory jsonFactory;

    public CamWriter240(JsonFactory jsonFactory) {
        this.jsonFactory = Objects.requireNonNull(jsonFactory, "jsonFactory");
    }

    public void write(CamEnvelope240 envelope, OutputStream out) throws IOException {
        ...
        try (JsonGenerator gen = jsonFactory.createGenerator(out)) {
            ...
            if (envelope.linkedStationId() != null) {
                gen.writeNumberField("linked_station_id", envelope.linkedStationId());
            }
    ...
    private void writePayload(JsonGenerator gen, CamMessage240 payload) throws IOException {
