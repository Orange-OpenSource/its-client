 ...
 * @param freeSpaceConfidence Isotropic free space confidence for the area. Value: unknown(0), onePercent(1), oneHundredPercent(100), unavailable(101).
 * @param sensorIdList List of sensor IDs which performed the measurement. Value: [0..255].
 * @param shadowingApplies True if simple shadowing mechanism applies within the area.
 */
